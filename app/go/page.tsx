        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 gap-8 md:gap-12 mb-16 max-w-3xl mx-auto">
            ...
            <div className="flex flex-col">
              <p className="text-lg md:text-xl font-black text-slate-900 mb-3 text-center">Ragsites Doubles Booking Rate to <span className="text-[#991b1b] underline">44% in Just One Month</span></p>
