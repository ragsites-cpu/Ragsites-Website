  ...
  return (
    <section id="demo-section" className="py-24 px-4">
      <div className="max-w-3xl mx-auto">
        ...
        >
          {/* Removed animated background glow for clean look */}
            ...
            {state === 'success' && (
              ...
              >
                <motion.div
                  ...
                  className="w-20 h-20 mx-auto mb-6 rounded-full bg-blue-50 border border-blue-100 flex items-center justify-center"
                >
                ...
                <motion.a
                  ...
                  whileHover={{ scale: 1.02 }}
                  whileTap={{ scale: 0.98 }}
                  className="inline-flex items-center gap-3 px-8 py-5 rounded-2xl bg-brand-accent text-white font-bold text-2xl md:text-3xl tracking-wider shadow-md hover:bg-brand-accent-hover transition-colors"
                >
